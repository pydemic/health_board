defmodule HealthBoardWeb.DashboardLive.CardData.DeathRateMap do
  ...
  defp fetch_rates(%{year_locations_deaths: cases, year_locations_population: populations, locations: locations}) do
  ...
  defp wrap_result(data, id, location) do
    %{
      id: id,
      label: "Coeficiente de mortalidade",
      data: data,
      location: location
    }
  end
