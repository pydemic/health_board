defmodule HealthBoardWeb.DashboardLive.Fragments.SarsDashboard.HospitalizationFatalityRateCard do
    ...
    <DataCard id={{ @card.id }} :let={{ data: data }} width_l={{ 3 }} width_m={{ 1 }} >
      ...
      <template slot="body" :let={{ data: data }} >
        <div class="uk-card-body">
          <h2 :if={{ Enum.any?(data) }}>{{ Humanize.number data.result.hospitalization_fatality_rate }}</h2>
