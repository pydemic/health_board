defmodule HealthBoardWeb.DashboardLive.IndicatorsData.ViolenceDomesticDeaths do
  alias HealthBoard.Contexts.Morbidities.YearlyMortalitiesCases
  alias HealthBoardWeb.DashboardLive.IndicatorsData

  @context YearlyMortalitiesCases
  ...
  def fetch(indicators_data) do
    ...
    |> IndicatorsData.exec_and_put(:modifiers, :disease_context, &get_disease_context/1)
  ...
  @spec get_disease_context(IndicatorsData.t()) :: integer()
  def get_disease_context(_indicators_data) do
    @context.domestic_violence_disease_context()
  end

  @spec get_location_context(IndicatorsData.t(), integer()) :: integer()
  def get_location_context(%{filters: filters}, default \\ @default_location_context) do
    Map.get(filters, "mortalities_location_context", default)
  end
