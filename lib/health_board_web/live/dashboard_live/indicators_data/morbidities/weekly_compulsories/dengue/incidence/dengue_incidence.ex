defmodule HealthBoardWeb.DashboardLive.IndicatorsData.DengueIncidence do
  alias HealthBoard.Contexts.Morbidities.DengueYearlyCases
  alias HealthBoardWeb.DashboardLive.IndicatorsData

  @context DengueYearlyCases
  @default_location_context @context.resident_location_context()

  @fields_filters ~w[dengue_classification dengue_serotype person_age_group person_race person_sex]
