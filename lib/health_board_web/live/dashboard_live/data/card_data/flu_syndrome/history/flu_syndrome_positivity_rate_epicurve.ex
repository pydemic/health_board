defmodule HealthBoardWeb.DashboardLive.CardData.FluSyndromePositivityRateEpicurve do
  ...
  defp fetch_rate(day_incidence, date) do
    Enum.find_value(
      day_incidence,
      0,
      &if(Date.compare(date, &1.date) == :eq, do: Math.positivity_rate(&1.confirmed, &1.discarded))
    )
  end
end
