defmodule HealthBoardWeb.DashboardLive.CardData.FluSyndromeHealthProfessionalIncidenceEpicurve do
  ...
  defp do_fetch(data) do
    ...
    incidences = Enum.map(dates, &fetch_incidence(daily_incidence, &1))
  ...
  defp fetch_incidence(day_incidence, date) do
    Enum.find_value(day_incidence, 0, &if(Date.compare(date, &1.date) == :eq, do: &1.health_professional))
  end
end
