defmodule HealthBoardWeb.DashboardLive.CardData.FluSyndromePandemicIncidencePerAgeGender do
  ...
  defp do_fetch(data) do
    ...
    %{
      ...
      positive_data: Enum.map(@female_fields, &Map.get(incidence, &1, 0)),
      negative_label: "Masculino",
      negative_data: Enum.map(@male_fields, &Map.get(incidence, &1, 0))
    }
  end
end
