defmodule HealthBoardWeb.DashboardLive.CardData.SituationReportIncidencePerWeek do
  ...
  defp fetch_data({year, week}, weekly_covid_reports) do
    Enum.find_value(weekly_covid_reports, 0, &if(&1.year == year and &1.week == week, do: &1.cases))
  end
