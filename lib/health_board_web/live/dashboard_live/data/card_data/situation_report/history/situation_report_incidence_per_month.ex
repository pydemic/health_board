defmodule HealthBoardWeb.DashboardLive.CardData.SituationReportIncidencePerMonth do
  ...
  defp fetch_data({year, month}, monthly_covid_reports) do
    Enum.find_value(monthly_covid_reports, 0, &if(&1.year == year and &1.month == month, do: &1.cases))
  end
