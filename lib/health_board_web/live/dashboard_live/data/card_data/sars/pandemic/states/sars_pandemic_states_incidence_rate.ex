defmodule HealthBoardWeb.DashboardLive.CardData.SarsPandemicStatesIncidenceRate do
  ...
  defp fetch_incidence_rate(%{confirmed: incidence, location_id: location_id} = state_incidence, populations) do
    %{total: population} = Enum.find(populations, %{total: 0}, &(&1.location_id == location_id))
    %{name: state_incidence.location_name, incidence_rate: Math.incidence_rate(incidence, population)}
  end
