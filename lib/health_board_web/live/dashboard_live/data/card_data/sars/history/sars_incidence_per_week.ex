defmodule HealthBoardWeb.DashboardLive.CardData.SarsIncidencePerWeek do
  ...
  defp fetch(%{weekly_incidence: weekly_incidence} = data) do
    months = fetch_months(data)

    months
    |> Enum.map(&fetch_data(&1, weekly_incidence))
  ...
  defp fetch_data({year, week}, weekly_incidence) do
    Enum.find_value(weekly_incidence, 0, &if(&1.year == year and &1.week == week, do: &1.confirmed))
  end
