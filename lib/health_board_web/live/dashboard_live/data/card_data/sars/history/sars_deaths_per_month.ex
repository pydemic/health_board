defmodule HealthBoardWeb.DashboardLive.CardData.SarsDeathsPerMonth do
  ...
  defp fetch(%{monthly_deaths: monthly_deaths} = data) do
    months = fetch_months(data)

    months
    |> Enum.map(&fetch_data(&1, monthly_deaths))
  ...
  defp fetch_data({year, month}, monthly_deaths) do
    Enum.find_value(monthly_deaths, 0, &if(&1.year == year and &1.month == month, do: &1.confirmed))
  end
