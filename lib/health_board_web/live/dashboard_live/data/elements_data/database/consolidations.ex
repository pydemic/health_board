defmodule HealthBoardWeb.DashboardLive.ElementsData.Database.Consolidations do
  ...
  @spec fetch_date(map, map, String.t()) :: {:ok, integer} | :error
  def fetch_date(data, params, key \\ "date") do
  ...
  @spec fetch_date_range(map, map) :: {:ok, integer | {integer | nil, integer | nil}} | :error
  def fetch_date_range(data, params) do
    case {fetch_date(data, params, "from_date"), fetch_date(data, params, "to_date")} do
      {:error, :error} -> fetch_date(data, params)
  ...
  @spec fetch_dates(map, map) :: {:ok, list({atom, list(integer) | integer})} | :error
  def fetch_dates(data, params) do
    case Map.fetch(params, "dates") do
      {:ok, dates} -> do_fetch_dates(data, dates)
      :error -> with :error <- Map.fetch(data, :dates), do: fetch_date_range(data, params)
    end
    |> case do
  ...
  @spec fetch_group(map, map) :: {:ok, integer} | :error
  def fetch_group(_data, params) do
    case params do
      %{"group" => group} -> {:ok, ConsolidationsGroups.fetch_id!(group)}
      _params -> :error
    end
  rescue
    _error -> :error
  ...
  @spec fetch_location_id(map, map) :: {:ok, integer} | :error
  def fetch_location_id(data, params) do
  ...
  @spec fetch_locations_ids(map, map) :: {:ok, list({atom, integer})} | :error
  def fetch_locations_ids(data, params) do
    case Map.fetch(params, "locations_ids") do
      {:ok, locations_ids} -> Map.fetch(data, String.to_atom(locations_ids))
      :error -> with :error <- Map.fetch(data, :locations_ids), do: fetch_location_id(data, params)
    end
    |> case do
  ...
  @spec fetch_month(map, map, String.t()) :: {:ok, integer} | :error
  def fetch_month(data, params, key \\ "month") do
    case Map.fetch(params, key) do
  ...
  @spec fetch_month_range(map, map) :: {:ok, integer | {integer | nil, integer | nil}} | :error
  def fetch_month_range(data, params) do
    case {fetch_month(data, params, "from_month"), fetch_month(data, params, "to_month")} do
      {:error, :error} -> fetch_month(data, params)
      {{:ok, from}, :error} -> {:ok, {from, nil}}
      {:error, {:ok, to}} -> {:ok, {nil, to}}
      {{:ok, from}, {:ok, to}} -> {:ok, {from, to}}
    end
  ...
  @spec fetch_months(map, map) :: {:ok, list({atom, list(integer) | integer})} | :error
  def fetch_months(data, params) do
    case Map.fetch(params, "months") do
      {:ok, months} -> do_fetch_months(data, months)
      :error -> with :error <- Map.fetch(data, :months), do: fetch_month_range(data, params)
    end
    |> case do
  ...
  @spec fetch_year(map, map, String.t()) :: {:ok, integer} | :error
  def fetch_year(data, params, key \\ "year") do
    case Map.fetch(params, key) do
  ...
  @spec fetch_year_range(map, map) :: {:ok, integer | {integer | nil, integer | nil}} | :error
  def fetch_year_range(data, params) do
    case {fetch_year(data, params, "from_year"), fetch_year(data, params, "to_year")} do
      {:error, :error} -> fetch_year(data, params)
      {{:ok, from}, :error} -> {:ok, {from, nil}}
      {:error, {:ok, to}} -> {:ok, {nil, to}}
      {{:ok, from}, {:ok, to}} -> {:ok, {from, to}}
    end
  ...
  @spec fetch_years(map, map) :: {:ok, {:years, list(integer)} | {:year, integer}} | :error
  def fetch_years(data, params) do
    case Map.fetch(params, "years") do
      {:ok, years} -> do_fetch_years(data, years)
      :error -> with :error <- Map.fetch(data, :years), do: fetch_year_range(data, params)
    end
    |> case do
  ...
  @spec fetch_week(map, map, String.t()) :: {:ok, integer} | :error
  def fetch_week(data, params, key \\ "week") do
    case Map.fetch(params, key) do
  ...
  @spec fetch_week_range(map, map) :: {:ok, integer | {integer | nil, integer | nil}} | :error
  def fetch_week_range(data, params) do
    case {fetch_week(data, params, "from_week"), fetch_week(data, params, "to_week")} do
      {:error, :error} -> fetch_week(data, params)
      {{:ok, from}, :error} -> {:ok, {from, nil}}
      {:error, {:ok, to}} -> {:ok, {nil, to}}
      {{:ok, from}, {:ok, to}} -> {:ok, {from, to}}
    end
  ...
  @spec fetch_weeks(map, map) :: {:ok, list({atom, list(integer) | integer})} | :error
  def fetch_weeks(data, params) do
    case Map.fetch(params, "weeks") do
      {:ok, weeks} -> do_fetch_weeks(data, weeks)
      :error -> with :error <- Map.fetch(data, :weeks), do: fetch_week_range(data, params)
    end
    |> case do
