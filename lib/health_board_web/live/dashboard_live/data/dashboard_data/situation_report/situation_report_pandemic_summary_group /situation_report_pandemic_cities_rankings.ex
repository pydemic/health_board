defmodule HealthBoardWeb.DashboardLive.SectionData.SituationReportPandemicCitiesRankings do
  alias HealthBoardWeb.DashboardLive.{CardData, DataManager}

  @changes_keys [:index, :cities_covid_reports, :year_cities_population]
  @data_keys [:date, :cities_covid_reports, :year_cities_population, :last_record_date]
