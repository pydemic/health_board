defmodule HealthBoardWeb.DashboardLive.SectionData.SituationReportDailyStatesRankings do
  alias HealthBoardWeb.DashboardLive.{CardData, DataManager}

  @changes_keys [:index, :day_states_covid_reports, :year_states_population]
  @data_keys [:date, :day_states_covid_reports, :year_states_population, :last_record_date]
