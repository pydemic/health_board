defmodule HealthBoardWeb.DashboardLive.SectionData.FluSyndromeDailySummary do
  alias HealthBoardWeb.DashboardLive.{CardData, DataManager}

  @changes_keys [:index, :day_incidence, :year_population]
  @data_keys [:date, :location_name, :day_incidence, :year_population, :last_record_date]
