defmodule HealthBoardWeb.DashboardLive.SectionData.SarsPandemicSummary do
  alias HealthBoardWeb.DashboardLive.{CardData, DataManager}

  @changes_keys [:index, :incidence, :deaths, :hospitalizations, :year_population]
  @data_keys [:date, :location_name, :incidence, :deaths, :hospitalizations, :year_population, :last_record_date]
