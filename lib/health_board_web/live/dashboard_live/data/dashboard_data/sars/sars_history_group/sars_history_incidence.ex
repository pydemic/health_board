defmodule HealthBoardWeb.DashboardLive.SectionData.SarsHistoryIncidence do
  ...
  @data_keys [:date, :location_name, :daily_incidence, :weekly_incidence, :monthly_incidence]
