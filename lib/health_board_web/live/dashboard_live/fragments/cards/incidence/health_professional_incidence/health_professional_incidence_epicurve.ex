defmodule HealthBoardWeb.DashboardLive.Fragments.HealthProfessionalIncidenceEpicurve do
  use Surface.Component

  alias HealthBoardWeb.DashboardLive.Components.{CardBodyCanvas, CardHeaderMenu, CardOffcanvasMenu, DataCard}
