defmodule HealthBoard.Scripts.Morbidities.WeeklyCompulsories.WhoopingCoughConsolidator do
  ...
  @spec run :: :ok
  def run do
    Consolidator.run("whooping_cough", &parse_line/2)
  end

  defp parse_line(line, cities) do
    [year, source_city_id, resident_city_id, age_code, sex, race, classification] = line
