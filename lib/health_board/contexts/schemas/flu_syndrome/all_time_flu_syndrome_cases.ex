defmodule HealthBoard.Contexts.Schemas.AllTimeFluSyndromeCases do
  use Ecto.Schema
  alias HealthBoard.Contexts.Geo

  schema "pandemic_flu_syndrome_cases" do
    field :registry_context, :integer, null: false
    ...
    field :female_64_69, :integer, default: 0
    field :male_64_69, :integer, default: 0
