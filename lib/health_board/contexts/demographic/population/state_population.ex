defmodule HealthBoard.Contexts.Demographic.StatePopulation do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.StatePopulation
  alias HealthBoard.Contexts.Geo

  schema "states_population" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%StatePopulation{}, map()) :: Ecto.Changeset.t()
  def changeset(state_population, attrs) do
    state_population
