defmodule HealthBoard.Contexts.Demographic.HealthRegionSourceYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.HealthRegionSourceYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "health_regions_source_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%HealthRegionSourceYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(health_region_source_yearly_births, attrs) do
    health_region_source_yearly_births
    |> cast(attrs, @cast_attrs)
    |> validate_required([:year, :health_region_id])
