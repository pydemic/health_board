defmodule HealthBoard.Contexts.Demographic.CountryPopulation do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.CountryPopulation
  alias HealthBoard.Contexts.Geo

  schema "countries_population" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%CountryPopulation{}, map()) :: Ecto.Changeset.t()
  def changeset(country_population, attrs) do
    country_population
