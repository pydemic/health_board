defmodule HealthBoard.Contexts.Demographic.HealthInstitutionSourceYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.HealthInstitutionSourceYearlyBirths
  alias HealthBoard.Contexts.Logistics

  schema "health_institutions_source_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%HealthInstitutionSourceYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(health_institution_source_yearly_births, attrs) do
    health_institution_source_yearly_births
    |> cast(attrs, @cast_attrs)
    |> validate_required([:year, :health_institution_id])
    |> unique_constraint([:year, :health_institution_id])
  end
end
