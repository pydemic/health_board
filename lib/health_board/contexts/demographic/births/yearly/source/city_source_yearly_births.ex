defmodule HealthBoard.Contexts.Demographic.CitySourceYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.CitySourceYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "cities_source_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%CitySourceYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(city_source_yearly_births, attrs) do
    city_source_yearly_births
