defmodule HealthBoard.Contexts.Demographic.RegionSourceYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.RegionSourceYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "regions_source_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%RegionSourceYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(region_source_yearly_births, attrs) do
    region_source_yearly_births
