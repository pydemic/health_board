defmodule HealthBoard.Contexts.Demographic.StateSourceYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.StateSourceYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "states_source_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%StateSourceYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(state_source_yearly_births, attrs) do
    state_source_yearly_births
