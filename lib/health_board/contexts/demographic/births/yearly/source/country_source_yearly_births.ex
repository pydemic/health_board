defmodule HealthBoard.Contexts.Demographic.CountrySourceYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.CountrySourceYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "countries_source_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%CountrySourceYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(country_source_yearly_births, attrs) do
    country_source_yearly_births
    |> cast(attrs, @cast_attrs)
    |> validate_required([:year, :country_id])
