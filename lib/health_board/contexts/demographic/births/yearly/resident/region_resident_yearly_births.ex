defmodule HealthBoard.Contexts.Demographic.RegionResidentYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.RegionResidentYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "regions_resident_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%RegionResidentYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(region_resident_yearly_births, attrs) do
    region_resident_yearly_births
    |> cast(attrs, @cast_attrs)
    |> validate_required([:year, :region_id])
    |> unique_constraint([:year, :region_id])
  end
end
