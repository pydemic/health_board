defmodule HealthBoard.Contexts.Demographic.StateResidentYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.StateResidentYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "states_resident_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%StateResidentYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(state_resident_yearly_births, attrs) do
    state_resident_yearly_births
    |> cast(attrs, @cast_attrs)
    |> validate_required([:year, :state_id])
    |> unique_constraint([:year, :state_id])
  end
end
