defmodule HealthBoard.Contexts.Demographic.HealthRegionResidentYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.HealthRegionResidentYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "health_regions_resident_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%HealthRegionResidentYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(health_region_resident_yearly_births, attrs) do
    health_region_resident_yearly_births
