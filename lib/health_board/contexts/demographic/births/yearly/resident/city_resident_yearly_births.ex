defmodule HealthBoard.Contexts.Demographic.CityResidentYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.CityResidentYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "cities_resident_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%CityResidentYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(city_resident_yearly_births, attrs) do
    city_resident_yearly_births
    |> cast(attrs, @cast_attrs)
    |> validate_required([:year, :city_id])
