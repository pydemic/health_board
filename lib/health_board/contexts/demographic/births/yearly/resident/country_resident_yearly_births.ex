defmodule HealthBoard.Contexts.Demographic.CountryResidentYearlyBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.CountryResidentYearlyBirths
  alias HealthBoard.Contexts.Geo

  schema "countries_resident_yearly_births" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%CountryResidentYearlyBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(country_resident_yearly_births, attrs) do
    country_resident_yearly_births
