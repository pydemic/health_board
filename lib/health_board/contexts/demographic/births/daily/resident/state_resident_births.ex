defmodule HealthBoard.Contexts.Demographic.StateResidentBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.StateResidentBirths
  alias HealthBoard.Contexts.Geo

  schema "states_resident_births" do
    field :date, :date
    field :year, :integer
    field :week, :integer
  ...
  @doc false
  @spec changeset(%StateResidentBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(state_resident_births, attrs) do
    state_resident_births
