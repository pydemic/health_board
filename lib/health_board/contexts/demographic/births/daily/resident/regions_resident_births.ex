defmodule HealthBoard.Contexts.Demographic.RegionsResidentBirths do
  ...
  defp filter_query(query, filters) do
    if Enum.any?(filters) do
      ...
      case filter do
        {:region_id, id} -> where(query, [t], t.region_id == ^id)
        {:regions_ids, ids} -> where(query, [t], t.region_id in ^ids)
