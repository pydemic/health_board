defmodule HealthBoard.Contexts.Demographic.CountryResidentBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.CountryResidentBirths
  alias HealthBoard.Contexts.Geo

  schema "countries_resident_births" do
    field :date, :date
    field :year, :integer
    field :week, :integer
  ...
  @doc false
  @spec changeset(%CountryResidentBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(country_resident_births, attrs) do
    country_resident_births
