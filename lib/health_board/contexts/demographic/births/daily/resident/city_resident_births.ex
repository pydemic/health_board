defmodule HealthBoard.Contexts.Demographic.CityResidentBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.CityResidentBirths
  alias HealthBoard.Contexts.Geo

  schema "cities_resident_births" do
    field :date, :date
    field :year, :integer
    field :week, :integer
  ...
  @doc false
  @spec changeset(%CityResidentBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(city_resident_births, attrs) do
    city_resident_births
