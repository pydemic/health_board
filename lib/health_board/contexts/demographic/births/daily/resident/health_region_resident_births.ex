defmodule HealthBoard.Contexts.Demographic.HealthRegionResidentBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.HealthRegionResidentBirths
  alias HealthBoard.Contexts.Geo

  schema "health_regions_resident_births" do
    field :date, :date
    field :year, :integer
    field :week, :integer
  ...
  @doc false
  @spec changeset(%HealthRegionResidentBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(health_region_resident_births, attrs) do
    health_region_resident_births
