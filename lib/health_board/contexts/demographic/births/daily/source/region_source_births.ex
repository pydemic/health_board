defmodule HealthBoard.Contexts.Demographic.RegionSourceBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.RegionSourceBirths
  alias HealthBoard.Contexts.Geo

  schema "regions_source_births" do
    field :date, :date
    field :year, :integer
    field :week, :integer
  ...
  @doc false
  @spec changeset(%RegionSourceBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(region_source_births, attrs) do
    region_source_births
