defmodule HealthBoard.Contexts.Demographic.YearlyLocationBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.YearlyLocationBirths
  alias HealthBoard.Contexts.Geo

  schema "yearly_locations_births" do
  ...
  @doc false
  @spec changeset(%YearlyLocationBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(yearly_location_births, attrs) do
    yearly_location_births
    |> cast(attrs, @cast_attrs)
    |> validate_required([:location_id, :location_context, :year])
  end
end
