defmodule HealthBoard.Contexts.Demographic.HealthInstitutionSourceBirths do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.HealthInstitutionSourceBirths
  alias HealthBoard.Contexts.Logistics

  schema "health_institutions_source_births" do
    field :date, :date
    field :year, :integer
    field :week, :integer
    ...
    belongs_to :health_institution, Logistics.HealthInstitution
  end
  ...
  @doc false
  @spec changeset(%HealthInstitutionSourceBirths{}, map()) :: Ecto.Changeset.t()
  def changeset(health_institution_source_births, attrs) do
    health_institution_source_births
    |> cast(attrs, @cast_attrs)
    |> validate_required([:date, :year, :week, :health_institution_id])
    |> unique_constraint([:date, :health_institution_id])
  end
end
