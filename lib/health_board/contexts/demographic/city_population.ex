defmodule HealthBoard.Contexts.Demographic.CityPopulation do
  use Ecto.Schema
  import Ecto.Changeset
  alias HealthBoard.Contexts.Demographic.CityPopulation
  alias HealthBoard.Contexts.Geo

  schema "cities_population" do
    field :year, :integer
  ...
  @doc false
  @spec changeset(%CityPopulation{}, map()) :: Ecto.Changeset.t()
  def changeset(city_population, attrs) do
    city_population
