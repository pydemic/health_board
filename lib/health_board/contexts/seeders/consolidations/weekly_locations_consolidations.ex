defmodule HealthBoard.Contexts.Seeders.Consolidations.WeeklyLocationsConsolidations do
  alias HealthBoard.Contexts.Seeder

  @context "consolidations"
  @table_name "weekly_locations_consolidations"
  @columns ~w[consolidation_group_id location_id year week total values]a
