defmodule HealthBoard.Contexts.SituationReport.YearlyCOVIDReports do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.SituationReport.YearCOVIDReports
  alias HealthBoard.Repo

  @type schema :: %YearCOVIDReports{}

  @schema YearCOVIDReports
