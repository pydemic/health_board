defmodule HealthBoard.Contexts.SituationReport.MonthlyCOVIDReports do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.SituationReport.MonthCOVIDReports
  alias HealthBoard.Repo

  @type schema :: %MonthCOVIDReports{}

  @schema MonthCOVIDReports
