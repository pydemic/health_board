defmodule HealthBoard.Contexts.Morbidities.YearlyMorbidities do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]

  alias HealthBoard.Contexts.Morbidities.YearMorbidity
  alias HealthBoard.Repo

  @type schema :: %YearMorbidity{}

  @schema YearMorbidity
