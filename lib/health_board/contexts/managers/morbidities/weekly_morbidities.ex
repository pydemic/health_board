defmodule HealthBoard.Contexts.Morbidities.WeeklyMorbidities do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]

  alias HealthBoard.Contexts.Morbidities.WeekMorbidity
  alias HealthBoard.Repo

  @type schema :: %WeekMorbidity{}

  @schema WeekMorbidity
