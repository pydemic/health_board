defmodule HealthBoard.Contexts.Morbidities.MalariaFromExtraAmazonYearlyCases do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.Morbidities.MalariaFromExtraAmazonYearCases
  alias HealthBoard.Repo

  @type schema :: %MalariaFromExtraAmazonYearCases{}

  @schema MalariaFromExtraAmazonYearCases
