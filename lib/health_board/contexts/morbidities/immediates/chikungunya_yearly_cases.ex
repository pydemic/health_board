defmodule HealthBoard.Contexts.Morbidities.ChikungunyaYearlyCases do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.Morbidities.ChikungunyaYearCases
  alias HealthBoard.Repo

  @type schema :: %ChikungunyaYearCases{}

  @schema ChikungunyaYearCases
