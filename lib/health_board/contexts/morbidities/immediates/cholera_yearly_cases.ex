defmodule HealthBoard.Contexts.Morbidities.CholeraYearlyCases do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.Morbidities.CholeraYearCases
  alias HealthBoard.Repo

  @type schema :: %CholeraYearCases{}

  @schema CholeraYearCases
