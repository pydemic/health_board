defmodule HealthBoard.Contexts.Morbidities.PlagueYearlyCases do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.Morbidities.PlagueYearCases
  alias HealthBoard.Repo

  @type schema :: %PlagueYearCases{}

  @schema PlagueYearCases
