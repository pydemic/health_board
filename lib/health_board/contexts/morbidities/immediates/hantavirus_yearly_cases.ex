defmodule HealthBoard.Contexts.Morbidities.HantavirusYearlyCases do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.Morbidities.HantavirusYearCases
  alias HealthBoard.Repo

  @type schema :: %HantavirusYearCases{}

  @schema HantavirusYearCases
