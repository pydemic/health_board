defmodule HealthBoard.Contexts.Morbidities.HantavirusYearCases do
  use Ecto.Schema
  alias HealthBoard.Contexts.Geo

  schema "hantavirus_yearly_cases" do
    ...
    field :type_home, :integer, default: 0
    field :type_work, :integer, default: 0
    field :type_leisure, :integer, default: 0
