defmodule HealthBoard.Contexts.Morbidities.CholeraYearCases do
  use Ecto.Schema
  alias HealthBoard.Contexts.Geo

  schema "cholera_yearly_cases" do
    ...
    field :type_unclean_water, :integer, default: 0
    field :type_sewer_exposure, :integer, default: 0
    field :type_food, :integer, default: 0
    field :type_displacement, :integer, default: 0
