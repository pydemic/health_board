defmodule HealthBoard.Contexts.Morbidities.MalariaFromExtraAmazonYearCases do
  use Ecto.Schema
  alias HealthBoard.Contexts.Geo

  schema "malaria_from_extra_amazon_yearly_cases" do
    ...
    field :exam_result_negative, :integer, default: 0
    field :exam_result_f, :integer, default: 0
    field :exam_result_f_plus_fg, :integer, default: 0
    field :exam_result_v, :integer, default: 0
    field :exam_result_f_plus_v, :integer, default: 0
    field :exam_result_v_plus_fg, :integer, default: 0
    field :exam_result_fg, :integer, default: 0
    field :ignored_exam_result, :integer, default: 0
