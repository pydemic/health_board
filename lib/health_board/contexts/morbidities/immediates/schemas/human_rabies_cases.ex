defmodule HealthBoard.Contexts.Morbidities.HumanRabiesYearCases do
  use Ecto.Schema
  alias HealthBoard.Contexts.Geo

  schema "human_rabies_yearly_cases" do
    ...
    field :type_canine, :integer, default: 0
    field :type_feline, :integer, default: 0
    field :type_chiroptera, :integer, default: 0
    field :type_primate, :integer, default: 0
    field :type_fox, :integer, default: 0
    field :type_herbivore, :integer, default: 0
    field :other_type, :integer, default: 0
    field :ignored_type, :integer, default: 0

    field :applied_serum, :integer, default: 0
    field :not_applied_serum, :integer, default: 0
    field :ignored_serum_application, :integer, default: 0
