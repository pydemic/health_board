defmodule HealthBoard.Contexts.Morbidities.ChikungunyaYearCases do
  use Ecto.Schema
  alias HealthBoard.Contexts.Geo

  schema "chikungunya_yearly_cases" do
    ...
    field :other_classification, :integer, default: 0
    ...
    field :evolution_in_investigation, :integer, default: 0
