defmodule HealthBoard.Contexts.Morbidities.HumanRabiesYearlyCases do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.Morbidities.HumanRabiesYearCases
  alias HealthBoard.Repo

  @type schema :: %HumanRabiesYearCases{}

  @schema HumanRabiesYearCases
