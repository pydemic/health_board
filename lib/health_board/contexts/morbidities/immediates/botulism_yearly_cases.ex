defmodule HealthBoard.Contexts.Morbidities.BotulismYearlyCases do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.Morbidities.BotulismYearCases
  alias HealthBoard.Repo

  @type schema :: %BotulismYearCases{}

  @schema BotulismYearCases
