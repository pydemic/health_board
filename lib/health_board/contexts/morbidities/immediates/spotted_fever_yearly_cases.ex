defmodule HealthBoard.Contexts.Morbidities.SpottedFeverYearlyCases do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.Morbidities.SpottedFeverYearCases
  alias HealthBoard.Repo

  @type schema :: %SpottedFeverYearCases{}

  @schema SpottedFeverYearCases
