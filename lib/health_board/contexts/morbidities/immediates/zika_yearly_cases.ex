defmodule HealthBoard.Contexts.Morbidities.ZikaYearlyCases do
  import Ecto.Query, only: [order_by: 2, where: 2, dynamic: 1, dynamic: 2]
  alias HealthBoard.Contexts.Morbidities.ZikaYearCases
  alias HealthBoard.Repo

  @type schema :: %ZikaYearCases{}

  @schema ZikaYearCases
