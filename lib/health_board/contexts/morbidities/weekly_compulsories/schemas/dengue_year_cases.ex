defmodule HealthBoard.Contexts.Morbidities.DengueYearCases do
  ...
  schema "dengue_yearly_cases" do
    ...
    field :confirmed_warning, :integer, default: 0
    field :confirmed_severe, :integer, default: 0
    field :confirmed_chikungunya, :integer, default: 0
    field :discarded, :integer, default: 0
    field :ignored_classification, :integer, default: 0

    field :serotype_1, :integer, default: 0
    field :serotype_2, :integer, default: 0
    field :serotype_3, :integer, default: 0
    field :serotype_4, :integer, default: 0
    field :ignored_serotype, :integer, default: 0
  ...
  @doc false
  @spec changeset(%DengueYearCases{}, map()) :: Ecto.Changeset.t()
  def changeset(dengue_year_cases, attrs) do
    dengue_year_cases
