defmodule HealthBoard.Updaters.CovidReportsUpdater.Consolidator do
  ...
  @ets_consolidations_groups :health_board_updaters_covid_reports__consolidations_groups
  @ets_daily_locations_buckets :health_board_covid_reports_updater__daily_consolidations
  @ets_weekly_locations_buckets :health_board_covid_reports_updater__weekly_consolidations
  @ets_monthly_locations_buckets :health_board_covid_reports_updater__monthly_consolidations
  @ets_yearly_locations_buckets :health_board_covid_reports_updater__yearly_consolidations
  @ets_locations_buckets :health_board_covid_reports_updater__locations_consolidations
