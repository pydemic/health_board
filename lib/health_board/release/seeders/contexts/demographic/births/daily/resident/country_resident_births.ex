defmodule HealthBoard.Release.Seeders.Contexts.Demographic.CountryResidentBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.CountryResidentBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 1_200
  @path "demographic/births/resident/resident_countries_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, CountryResidentBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
