defmodule HealthBoard.Release.Seeders.Contexts.Demographic.HealthInstitutionSourceBirths do
  require Logger
  ...
  @batch_size 1_200
  @path "demographic/births/source/source_health_institutions_births.zip"
  ...
  def seed(opts \\ []) do
    ...
    Seeder.seed(@path, HealthInstitutionSourceBirths, &parse/2, opts)
  end
