defmodule HealthBoard.Release.Seeders.Contexts.Demographic.CitySourceBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.CitySourceBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 1_200
  @path "demographic/births/source/source_cities_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, CitySourceBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
