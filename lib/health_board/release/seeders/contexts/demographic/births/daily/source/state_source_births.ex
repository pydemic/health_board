defmodule HealthBoard.Release.Seeders.Contexts.Demographic.StateSourceBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.StateSourceBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 1_200
  @path "demographic/births/source/source_states_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, StateSourceBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
