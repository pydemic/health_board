defmodule HealthBoard.Release.Seeders.Contexts.Demographic.CountrySourceBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.CountrySourceBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 1_200
  @path "demographic/births/source/source_countries_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, CountrySourceBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
