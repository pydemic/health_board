defmodule HealthBoard.Release.Seeders.Contexts.Demographic.CityResidentBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.CityResidentBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 1_200
  @path "demographic/births/resident/resident_cities_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, CityResidentBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
