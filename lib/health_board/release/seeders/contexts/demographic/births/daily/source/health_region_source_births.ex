defmodule HealthBoard.Release.Seeders.Contexts.Demographic.HealthRegionSourceBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.HealthRegionSourceBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 1_200
  @path "demographic/births/source/source_health_regions_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, HealthRegionSourceBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
