defmodule HealthBoard.Release.Seeders.Contexts.Demographic.RegionSourceBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.RegionSourceBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 1_200
  @path "demographic/births/source/source_regions_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, RegionSourceBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
