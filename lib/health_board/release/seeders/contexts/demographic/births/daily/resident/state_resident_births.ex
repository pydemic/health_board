defmodule HealthBoard.Release.Seeders.Contexts.Demographic.StateResidentBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.StateResidentBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 1_200
  @path "demographic/births/resident/resident_states_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, StateResidentBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
