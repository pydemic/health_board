defmodule HealthBoard.Release.Seeders.Contexts.Demographic.RegionResidentBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.RegionResidentBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 1_200
  @path "demographic/births/resident/resident_regions_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, RegionResidentBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
  ...
  defp parse([date | data], file_name) do
    ...
    |> Map.put(:region_id, String.to_integer(file_name))
  end
end
