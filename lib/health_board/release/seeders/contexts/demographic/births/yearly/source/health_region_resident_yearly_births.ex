defmodule HealthBoard.Release.Seeders.Contexts.Demographic.HealthRegionSourceYearlyBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.HealthRegionSourceYearlyBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 3_000
  @path "demographic/births_yearly/source/yearly_source_health_regions_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, HealthRegionSourceYearlyBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
