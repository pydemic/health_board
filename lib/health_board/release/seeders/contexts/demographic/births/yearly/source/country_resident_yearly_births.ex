defmodule HealthBoard.Release.Seeders.Contexts.Demographic.CountrySourceYearlyBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.CountrySourceYearlyBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 3_000
  @path "demographic/births_yearly/source/yearly_source_countries_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, CountrySourceYearlyBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
