defmodule HealthBoard.Release.Seeders.Contexts.Demographic.RegionResidentYearlyBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.RegionResidentYearlyBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 3_000
  @path "demographic/births_yearly/resident/yearly_resident_regions_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, RegionResidentYearlyBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
