defmodule HealthBoard.Release.Seeders.Contexts.Demographic.StateResidentYearlyBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.StateResidentYearlyBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 3_000
  @path "demographic/births_yearly/resident/yearly_resident_states_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, StateResidentYearlyBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
  ...
  defp parse(data, file_name) do
    ...
    |> Map.new()
    |> Map.put(:state_id, String.to_integer(file_name))
  end
end
