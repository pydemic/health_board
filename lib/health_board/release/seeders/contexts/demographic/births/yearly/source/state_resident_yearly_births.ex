defmodule HealthBoard.Release.Seeders.Contexts.Demographic.StateSourceYearlyBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.StateSourceYearlyBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 3_000
  @path "demographic/births_yearly/source/yearly_source_states_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, StateSourceYearlyBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
