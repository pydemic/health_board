defmodule HealthBoard.Release.Seeders.Contexts.Demographic.CitySourceYearlyBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.CitySourceYearlyBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 3_000
  @path "demographic/births_yearly/source/yearly_source_cities_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, CitySourceYearlyBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
