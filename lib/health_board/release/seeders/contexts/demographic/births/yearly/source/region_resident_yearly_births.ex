defmodule HealthBoard.Release.Seeders.Contexts.Demographic.RegionSourceYearlyBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.RegionSourceYearlyBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 3_000
  @path "demographic/births_yearly/source/yearly_source_regions_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, RegionSourceYearlyBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
