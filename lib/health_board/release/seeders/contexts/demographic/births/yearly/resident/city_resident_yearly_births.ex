defmodule HealthBoard.Release.Seeders.Contexts.Demographic.CityResidentYearlyBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.CityResidentYearlyBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 3_000
  @path "demographic/births_yearly/resident/yearly_resident_cities_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, CityResidentYearlyBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
  ...
  defp parse(data, file_name) do
    ...
    |> Map.new()
    |> Map.put(:city_id, String.to_integer(file_name))
  end
end
