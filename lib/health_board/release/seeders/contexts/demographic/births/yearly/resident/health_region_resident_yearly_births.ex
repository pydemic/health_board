defmodule HealthBoard.Release.Seeders.Contexts.Demographic.HealthRegionResidentYearlyBirths do
  require Logger
  alias HealthBoard.Contexts.Demographic.HealthRegionResidentYearlyBirths
  alias HealthBoard.Release.Seeders.Seeder

  @batch_size 3_000
  @path "demographic/births_yearly/resident/yearly_resident_health_regions_births.zip"
  ...
  def seed(opts \\ []) do
    Seeder.seed(@path, HealthRegionResidentYearlyBirths, &parse/2, Keyword.put(opts, :batch_size, @batch_size))
  end
