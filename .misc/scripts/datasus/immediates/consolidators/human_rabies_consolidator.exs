defmodule HealthBoard.Scripts.DATASUS.Immediates.HumanRabiesConsolidator do
  require Logger
  alias HealthBoard.Contexts.Geo

  @dir Path.join(File.cwd!(), ".misc/sandbox")

  @source_path Path.join(@dir, "sources/registries/human_rabies.csv")
  @results_dir Path.join(@dir, "immediates/human_rabies")
  ...
  defp parse_line(line, cities) do
    [date, source_city_id, resident_city_id, age_code, sex, classification, type, serum_application] = line
...
HealthBoard.Scripts.DATASUS.Immediates.HumanRabiesConsolidator.run()
