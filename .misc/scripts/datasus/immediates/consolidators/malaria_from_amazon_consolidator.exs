defmodule HealthBoard.Scripts.DATASUS.Immediates.MalariaFromAmazonConsolidator do
  require Logger
  alias HealthBoard.Contexts.Geo

  @dir Path.join(File.cwd!(), ".misc/sandbox")

  @source_path Path.join(@dir, "sources/registries/malaria_from_amazon.csv")
  @results_dir Path.join(@dir, "immediates/malaria_from_amazon")
  ...
  defp parse_line([date, source_city_id, resident_city_id, age_code, sex, classification, exam_result], cities) do
...
HealthBoard.Scripts.DATASUS.Immediates.MalariaFromAmazonConsolidator.run()
