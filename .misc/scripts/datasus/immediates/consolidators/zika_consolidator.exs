defmodule HealthBoard.Scripts.DATASUS.Immediates.ZikaConsolidator do
  require Logger
  alias HealthBoard.Contexts.Geo

  @dir Path.join(File.cwd!(), ".misc/sandbox")

  @source_path Path.join(@dir, "sources/registries/zika.csv")
  @results_dir Path.join(@dir, "immediates/zika")
...
HealthBoard.Scripts.DATASUS.Immediates.ZikaConsolidator.run()
