defmodule HealthBoard.Scripts.DATASUS.Immediates.YellowFeverConsolidator do
  require Logger
  alias HealthBoard.Contexts.Geo

  @dir Path.join(File.cwd!(), ".misc/sandbox")

  @source_path Path.join(@dir, "sources/registries/yellow_fever.csv")
  @results_dir Path.join(@dir, "immediates/yellow_fever")
  ...
  defp parse_line(line, cities) do
    [date, source_city_id, resident_city_id, age_code, sex, classification, evolution, vaccine_application] = line
...
HealthBoard.Scripts.DATASUS.Immediates.YellowFeverConsolidator.run()
