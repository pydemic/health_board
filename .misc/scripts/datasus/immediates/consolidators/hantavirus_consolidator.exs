defmodule HealthBoard.Scripts.DATASUS.Immediates.HantavirusConsolidator do
  require Logger
  alias HealthBoard.Contexts.Geo

  @dir Path.join(File.cwd!(), ".misc/sandbox")

  @source_path Path.join(@dir, "sources/registries/hantavirus.csv")
  @results_dir Path.join(@dir, "immediates/hantavirus")
...
HealthBoard.Scripts.DATASUS.Immediates.HantavirusConsolidator.run()
