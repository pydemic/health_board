defmodule HealthBoard.Scripts.DATASUS.Immediates.PlagueConsolidator do
  require Logger
  alias HealthBoard.Contexts.Geo

  @dir Path.join(File.cwd!(), ".misc/sandbox")

  @source_path Path.join(@dir, "sources/registries/plague.csv")
  @results_dir Path.join(@dir, "immediates/plague")
  ...
  defp parse_line(line, cities) do
    [date, source_city_id, resident_city_id, age_code, sex, classification, evolution, form, gravity] = line
...
HealthBoard.Scripts.DATASUS.Immediates.PlagueConsolidator.run()
