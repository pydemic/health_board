defmodule HealthBoard.Scripts.DATASUS.Immediates.SpottedFeverConsolidator do
  require Logger
  alias HealthBoard.Contexts.Geo

  @dir Path.join(File.cwd!(), ".misc/sandbox")

  @source_path Path.join(@dir, "sources/registries/spotted_fever.csv")
  @results_dir Path.join(@dir, "immediates/spotted_fever")
  ...
  defp parse_line([date, source_city_id, resident_city_id, age_code, sex, classification, evolution], cities) do
...
HealthBoard.Scripts.DATASUS.Immediates.SpottedFeverConsolidator.run()
