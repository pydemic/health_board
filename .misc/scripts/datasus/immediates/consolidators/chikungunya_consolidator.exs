defmodule HealthBoard.Scripts.DATASUS.Immediates.ChikungunyaConsolidator do
  require Logger
  alias HealthBoard.Contexts.Geo

  @dir Path.join(File.cwd!(), ".misc/sandbox")

  @source_path Path.join(@dir, "sources/registries/chikungunya.csv")
  @results_dir Path.join(@dir, "immediates/chikungunya")
...
HealthBoard.Scripts.DATASUS.Immediates.ChikungunyaConsolidator.run()
