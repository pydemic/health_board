defmodule HealthBoard.Repo.Migrations.CreateYearlyBirths do
  use Ecto.Migration

  def change do
    create table(:yearly_births) do
      ...
      add :child_male, :integer, default: 0
      add :child_female, :integer, default: 0
      add :ignored_child_gender, :integer, default: 0
